<template>
  <div>
    <nav-menu />
      <div class="container">
        <h1 class="title is-4 fancy">Terms & Conditions</h1>
          <p>
          ...
          <p>
            ...
            not continue to use tinythoughts's website if you do not accept all of the terms and
          ...
          <p>
            ...
            products, in accordance with and subject to, prevailing law of the United States. Any
            use of the above terminology or other words in the singular, plural, capitalisation
            and/or he/she or they, are taken as interchangeable and therefore as referring to same.
          </p>
          <h2 class="title is-5">Cookies</h2>
          <p>
            We employ the use of cookies. By using tinythoughts's website you consent to the use of
            cookies in accordance with tinythoughts’s privacy policy.
          </p>
          <p>
          ...
          <h2 class="title is-5">License</h2>
          <p>
            Unless otherwise stated, tinythoughts and/or it’s licensors own the intellectual
            property rights for all material on tinythoughts. All intellectual property rights
            are reserved. You may view and/or print pages from https://tinythoughts.me for your
            own personal use subject to restrictions set in these terms and conditions.
          </p>
          <p>You must not:</p>
          <ol>
            <li>Republish material from https://tinythoughts.me</li>
            <li>Sell, rent or sub-license material from https://tinythoughts.me</li>
            <li>Reproduce, duplicate or copy material from https://tinythoughts.me</li>
          </ol>
          <p>
            Redistribute content from tinythoughts (unless content is specifically made for
            redistribution).
          </p>
          <h2 class="title is-5">Hyperlinking to our Content</h2>
          <p>
          ...
          <p>
            ...
            the link would not reflect unfavorably on us or our accredited businesses
            (for example, trade associations or other organizations representing inherently
            suspect types of business, such as work-at-home opportunities, shall not be allowed
            to link); (b)the organization does not have an unsatisfactory record with us;
            (c) the benefit to us from the visibility associated with the hyperlink outweighs
            the absence; and (d) where the link is in the context of general resource information
            or is otherwise consistent with editorial content in a newsletter or similar product
          ...
          <p>
            ...
            <a href="mailto:tinythoughtsapp@gmail.com">tinythoughtsapp@gmail.com</a>. Please include
            your name, your organization name, contact information (such as a phone number
            and/or e-mail address) as well as the URL of your site, a list of any URLs from which
            you intend to link to our Web site, and a list of the URL(s) on our site to which you
          ...
          <p>
            No use of tinythoughts’s logo or other artwork will be allowed for linking
            absent a trademark license agreement.
          </p>
          <h2 class="title is-5">Iframes</h2>
          <p>
            Without prior approval and express written permission, you may not create frames
            around our webpages or use other techniques that alter in any way the visual
            presentation or appearance of our website.
          </p>
          <h2 class="title is-5">Reservation of Rights</h2>
          <p>
            ...
            and conditions and its linking policy at any time. By continuing to link to our website,
            you agree to be bound to and abide by these linking terms and conditions.
          </p>
          <h2 class="title is-5">Removal of links from our website</h2>
          <p>
            If you find any link on our Web site or any linked web site objectionable for any
            reason, you may contact us about this. We will consider requests to remove links
          ...
          <h2 class="title is-5">Content Liability</h2>
          <p>
          ...
          <p>
            The limitations and exclusions of liability set out in this Section and elsewhere
            in this disclaimer: (a) are subject to the preceding paragraph; and (b) govern all
          ...
          <h2 class="title is-5">Credit & Contact Information</h2>
          <p>
            This Terms and conditions page was created at
            <a target="_blank" href="https://termsandconditionstemplate.com">termsandconditionstemplate.com</a>
